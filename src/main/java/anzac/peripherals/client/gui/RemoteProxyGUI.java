...
public class RemoteProxyGUI extends GuiContainer {

	public static final ResourceLocation gui = new ResourceLocation(Reference.MOD_ID.toLowerCase(),
			"textures/gui/remoteproxy.png");

	public RemoteProxyGUI(final InventoryPlayer inventoryPlayer, final RemoteProxyTileEntity tileEntity) {
		super(new RemoteProxyContainer(inventoryPlayer, tileEntity));
		ySize = 166;
	}
	...
	protected void drawGuiContainerForegroundLayer(final int p_146979_1_, final int p_146979_2_) {
		...
		final String title = StatCollector.translateToLocal(Names.getGUIKey(Blocks.remoteproxy));
