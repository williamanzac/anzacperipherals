...
public class AnvilContainer extends BaseContainer<AnvilTileEntity> {

	private int lastAmount;
	private int lastId;

	public AnvilContainer(final InventoryPlayer inventoryPlayer, final AnvilTileEntity te) {
		super(te);

		// input
		addSlotToContainer(new ValidatingSlot(te, 0, 62, 53));
		addSlotToContainer(new ValidatingSlot(te, 1, 98, 53));
		// output
		addSlotToContainer(new SlotOutput(te, 2, 152, 53));
